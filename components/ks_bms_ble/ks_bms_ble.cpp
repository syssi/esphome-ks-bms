...
void KsBmsBle::decode_status_data_(const std::vector<uint8_t> &data) {
  ...
  this->publish_state_(this->charging_binary_sensor_, (bool) check_bit_(ks_get_16bit(29), 1));
  this->publish_state_(this->discharging_binary_sensor_, (bool) check_bit_(ks_get_16bit(29), 2));
